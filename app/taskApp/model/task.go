...
type Task struct {
	...
	TaskStatus           int        `gorm:"column:task_status" json:"TaskStatus"`                      //type:*int         comment:任务状态              version:2023-04-02 00:05
	...
	TaskDescribe         string     `gorm:"column:task_describe" json:"TaskDescribe"`                  //type:string       comment:任务描述              version:2023-04-02 00:05
	TaskCycle            int        `gorm:"column:task_cycle" json:"TaskCycle"`                        //type:*int         comment:任务阶段              version:2023-04-02 00:05
	TaskDuty             string     `gorm:"column:task_duty" json:"TaskDuty"`                          //type:string       comment:任务职责              version:2023-04-02 00:05
	TaskGetQualification string     `gorm:"column:task_get_qualification" json:"TaskGetQualification"` //type:string       comment:任务任职资格          version:2023-04-02 00:05
	TaskAddress          string     `gorm:"column:task_address" json:"TaskAddress"`                    //type:string       comment:任务地址              version:2023-04-02 00:05
	TaskBegin            *time.Time `gorm:"column:task_begin" json:"TaskBegin"`                        //type:*time.Time   comment:任务开始时间          version:2023-04-02 00:05
	TaskEnd              *time.Time `gorm:"column:task_end" json:"TaskEnd"`                            //type:*time.Time   comment:任务结束时间          version:2023-04-02 00:05
