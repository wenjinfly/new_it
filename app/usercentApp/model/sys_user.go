...
type SysUsers struct {
	...
	AuthorityId  string           `gorm:"column:authority_id;default:888;comment:用户角色ID" json:"AuthorityId"` //type:string            comment:用户角色ID      version:2023-03-12 00:10
	...
	Authority    SysAuthorities   `json:"authority" gorm:"-"`
