...
type SysBaseMenus struct {
	MenusId     uint64    `gorm:"column:menus_id;primaryKey" json:"MenusId"` //type:                  comment:菜单ID              version:2023-03-12 22:57
	...
	ParentId    string    `gorm:"column:parent_id" json:"ParentId"`          //type:string            comment:父菜单ID            version:2023-03-12 22:57
